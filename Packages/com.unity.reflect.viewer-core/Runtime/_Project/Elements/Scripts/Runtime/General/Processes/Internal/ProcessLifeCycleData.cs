...
namespace Elements.General.Processes
{
    public class ProcessLifeCycleData : MonoBehaviour
    {
        ...
        public AssetStateMaterialSO AssetStateMaterialDatabase;
        ...
        public void ProcessJsonData(string data)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                assetLifeCycle.CurrentLifeCycle =
                    new AssetLifeCycleState(assetState, (float) degredationValue, DetermineAssetMaterial(assetState));
                ...
                for (int j = initialYear + 1; j <= initialYear + timeLapse; j++)
                {
                    ...
                    assetLifeCycle.LifeCycleDictionary
                                  .Add(j,
                                       new AssetLifeCycleState(assetState, (float) degredationValue,
