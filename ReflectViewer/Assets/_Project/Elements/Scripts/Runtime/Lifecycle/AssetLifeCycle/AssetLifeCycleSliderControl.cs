...
{
    public class AssetLifeCycleSliderControl : NumericInputFieldPropertyControl, IPointerDownHandler, IPointerUpHandler
    {
...
#pragma warning restore 649
        ...
        void Start()
        {
            ...
            onIntValueChanged.AddListener((value) => OnYearChanged(value));
        }
