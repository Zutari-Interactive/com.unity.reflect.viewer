...
namespace Elements.LaserPointer
{
    public class Pointer3D : NetworkedBehaviour
    {
        ...
        private Vector3 _cachedPointerPosition = Vector3.zero;
        ...
        {
            _camera = Camera.main;
            _cachedPointerPosition = m_HandTransform.position;
        }
        ...
        public Vector3 MousePointer()
        {
            ...
            m_Results.Clear();
            m_ObjectPicker.Pick(_ray, m_Results);

            Pointer.SetPosition(0, m_HandTransform.position);

            if (m_Results.Count == 0)
                return m_HandTransform.position;

            _pointer = m_Results[0].Item2.point;
            _cachedPointerPosition = _pointer;
        ...
        public void SetPointerPositionToCacheValue()
        {
            PointerPosition.Value = _cachedPointerPosition;
        }
